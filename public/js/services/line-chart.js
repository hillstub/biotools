...
setScalesDomain: function(scales, data, series, svg, axesOptions) {
  ...
  if(axesOptions.y && axesOptions.y.hasOwnProperty('maxY')){yDomain[1] = axesOptions.y.maxY;}
  if(axesOptions.y2 && axesOptions.y2.hasOwnProperty('maxY')){y2Domain[1] = axesOptions.y2.maxY;}
